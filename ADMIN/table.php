...
<body>
    ...
    <div id="right-panel" class="right-panel">
        ...
        $sql="select akun.id_pelanggan, akun.Nama, pesan.id_pesan, pesan.people,
        pesan.meja, pesan.date, pesan.time from pesan join akun on akun.id_pelanggan=pesan.id_pelanggan left join pembayaran on pesan.id_pesan = pembayaran.id_pesan where pembayaran.total IS NULL";
        ...
        <tr align="center">
            ...
            <th class="text-center">BANYAK ORANG</th>
    ...
    while($row = mysqli_fetch_array($data))
   {
    echo '
                ...
                <td><button><a href="bayar.php?id_pesanan='.$row['id_pesan'].'">Bayar</a></button</td>
                </tr>';   
