...
<body>
    ...
    <div id="right-panel" class="right-panel">
     ...
     <?php
            ...
            $sql= "SELECT pesan.people, nama_menu.Nama_Menu, pesan.clientrequest, menu.harga, menu.jumlah FROM menu join nama_menu on nama_menu.id_namamenu = menu.id_namamenu join pesan on pesan.id_pesan=menu.id_pesan where menu.id_pesan='$id_pesanan'";
