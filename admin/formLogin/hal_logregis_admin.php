                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1><strong>Silahkan Login Dengan Akun Yang Sudah Ada</strong></h1>
                        ...
                        <div class="col-sm-5">
                        	...
                        	<div class="form-box" action="#">
                        		<div class="form-top">
	                        		<div class="form-top-left">
	                        			<h3>Atention</h3>
	                            		<p>Di Mohon Bagi Admin Untuk Memperhatikan :</p>
                                        <p>
                                    <a href="#">
                                        <span class="glyphicon glyphicon-pencil"></span> <b>Kejujuran</b>
                                    </a>
                                  </p>
                                           <p>
                                    <a href="#">
                                        <span class="glyphicon glyphicon-pencil"></span> <b>Kebersihan</b>
                                    </a>
                                  </p>
                                           <p>
                                    <a href="#">
                                        <span class="glyphicon glyphicon-pencil"></span> <b>Kedisiplinan</b>
                                    </a>
                                  </p>
                                           <p>
                                    <a href="#">
                                        <span class="glyphicon glyphicon-pencil"></span> <b>Kesopanan</b>
                                    </a>
                                  </p>
                                           <p>
                                    <a href="#">
                                        <span class="glyphicon glyphicon-pencil"></span> <b>Keikhlasan</b>
                                    </a>
                                  </p>
                                        <p></p>
                                        <p></p>
                                        ...
                                        <marquee><p>Terima Kasih Selamat Bekerja  <i class="fa fa-smile-o"></i></p></marquee>
                                     </div>
	                        		<div class="form-top-right">
        	...
        	<div class="container">
        		<div class="row">
        			...
        			<div class="col-sm-8 col-sm-offset-2">
        				...
        				<p>Discover By <a href="www.instagram.com/medidarmawan/" target="_blank"><strong>LongTime</strong></a> 
        					having a lot of longtime <i class="fa fa-smile-o"></i></p>
        			</div>
