                ...
                <div class="container">
                    ...
                    <div class="menu">
                        ...
                        <div class="tab-content">
                            ...
                            <div role="tabpanel" class="tab-pane active" id="breakfast">
                                <div class="row">
                                   <!-- item -->
                                    <?php
                                    //take data
                                    $result=mysqli_query($koneksi, "SELECT * FROM menu where jenis=\"spesial\" ");
                                    
                                    while($row=mysqli_fetch_assoc($result))
                                    {echo "<div class=\"col-sm-6\">";
                                        echo "<div class=\"menu-item clearfix\">";
                                        echo "<!--<div class=\"menu-item recommended has-border clearfix\">-->";
                                            echo "<div class=\"item-details pull-left\">";
                                                echo "<h5>$row[jenis_menu]</h5>";
                                                echo "<p>Tersedia</p>";
                                            echo "</div>";
                                            echo "<div class=\"item-price pull-right\">";
                                                echo "<strong class=\"text-large text-primary\">$row[harga]</strong>";
                                              echo "<!--  <span class=\"text-medium\">Recommended</span>-->";
                                            echo "</div>";
                                        echo "</div>";
                                     echo "</div>";
                                    }
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="lunch">
                                <div class="row">
                                    <!-- item -->
                                  	<?php
                                    //take data
                                    $result=mysqli_query($koneksi, "SELECT * FROM favorit where jenis=\"makanan\" ");
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="dinner">
                                <div class="row">
                                    <!-- item -->
                                  	...
                                  	<?php
                                    //take data
                                    $result=mysqli_query($koneksi, "SELECT * FROM favorit where jenis=\"minuman\" ");
                            ...
                            <div role="tabpanel" class="tab-pane fade" id="party">
                                <div class="row">
                                    ...
                                    <!-- item -->
                                  	<?php
                                    //take data
                                    $result=mysqli_query($koneksi, "SELECT * FROM menu where jenis=\"makanan\" ");
                        	...
                        	<?php
                                    //take data
                                    $result=mysqli_query($koneksi, "SELECT * FROM menu where jenis=\"minuman\" ");
