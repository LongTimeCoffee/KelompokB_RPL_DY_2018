            ...
            <div class="form-box" action="#">
	           ...
	           <div class="form-bottom">
                   ...
                   <div class="tabb">
                    ...
                    <tr>
                         <td><?php echo $row["id_namamenu"];?></td>
                      <td><?php echo $row["Nama_Menu"];?></td>
                      <td><?php echo $row["Kategori"];?></td>
                      <td><?php echo $row["Harga"];?></td>
                         <td><a onclick="return confirm('Are you sure you want to delete this entry?')" href="actiondelete.php?id_namamenu=<?= $row['id_namamenu'] ?>" class='btn btn-danger'>Delete</a></td>
                    </tr>
                            <?php endwhile; ?>
